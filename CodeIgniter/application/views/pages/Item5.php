<header id="head" class="secondary"></header>
	...
	<table class="cell">
		<tr>
			<td rowspan="3">
			<p><img src="<?=img_url();?>claude_monet.gif" alt="Photo de Claude Monet"></p>
			</td>
			<td>
	...
	<tr>
		<td>
		<p><img src="<?=img_url();?>oeuvre_impressionniste_monet_3.jpg" alt="La jeune femme a l'ombrelle" /></p>
		</td>
		<td>
		<p><img src="<?=img_url();?>oeuvre_impressionniste_monet_2.jpg" alt="Les coquelicots a argenteuil" /></p>
		</td>
	</tr>
	<tr>
		<td align="center">
